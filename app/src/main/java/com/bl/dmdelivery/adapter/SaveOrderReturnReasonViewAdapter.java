...
public class SaveOrderReturnReasonViewAdapter extends RecyclerView.Adapter<SaveOrderReturnReasonViewAdapter.ViewHolder>  {
    ...
    public SaveOrderReturnReasonViewAdapter(Context context, ArrayList<Reason> Data) {
    ...
    public void onBindViewHolder( final ViewHolder holder,final int position) {
        ...
        try
        {
            ...
            if(f.getReason_type().equals("RETURN_ACCEPT"))
            {
