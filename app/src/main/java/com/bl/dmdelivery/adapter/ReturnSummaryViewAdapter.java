...
public class ReturnSummaryViewAdapter extends RecyclerView.Adapter<ReturnSummaryViewAdapter.ViewHolder>  {
    private Context mContext;
    private ArrayList<OrderReturn> mData;
    private int lastPosition = -1;

    public ReturnSummaryViewAdapter(Context context, ArrayList<OrderReturn> Data) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(mContext).inflate(R.layout.list_row_order_return_summary, parent, false);
    ...
    public void onBindViewHolder( final ViewHolder holder,final int position) {
        ...
        try
        {
            ...
            holder.txtReturn_unit_real.setTypeface(typeface);


            if(f.getReturn_unit_real().equals("") || f.getReturn_unit_real().isEmpty() || f.getReturn_unit_real()==null)
            {
                holder.txtReturn_unit_real.setText(String.valueOf(f.getReturn_unit()));
            }
            else if(f.getReturn_unit_real().equals("0"))
            {
                holder.txtReturn_unit_real.setText("0");
            }
            else
            {
                holder.txtReturn_unit_real.setText(String.valueOf(f.getReturn_unit_real()));
            }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public TextView txtFscode,txtFsname,txtReq,txtReturn_unit_real;
        ...
        public ViewHolder(View v) {
            ...
            this.txtReturn_unit_real = (TextView) v.findViewById(R.id.txtReturn_unit_real);
