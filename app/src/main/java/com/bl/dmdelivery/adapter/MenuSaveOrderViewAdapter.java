    ...
    public void onBindViewHolder( final ViewHolder holder,final int position) {
        ...
        try
        {
            ...
            switch(f.getMenuname_type().toString()) {
                ...
                case "5":
                    holder.mImage.setImageResource(R.mipmap.ic_addressfilled50);
                    break;

                case "6":
                    holder.mImage.setImageResource(R.mipmap.ic_googlemapsfilled50);
                    break;

                case "7":
                    holder.mImage.setImageResource(R.mipmap.ic_navigationfilled50);
                    break;
                case "8":
                    holder.mImage.setImageResource(R.mipmap.ic_list48);
                    break;
