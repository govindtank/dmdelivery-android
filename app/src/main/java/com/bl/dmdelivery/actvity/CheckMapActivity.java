...
public class CheckMapActivity extends AppCompatActivity implements GoogleMap.InfoWindowAdapter ,OnMapReadyCallback {
...
//            getOrder();
    ...
    private void bindWidget()
    {
        try{
            ...
            mTxtHeader.setText(getResources().getString(R.string.txt_text_headder_check_map));
...
//    }
    ...
    public void onMapReady(GoogleMap map) {
        ...
        pos = new LatLng (Double.parseDouble(slatlng[0]), Double.parseDouble(slatlng[1]));
